...
export const Route = createFileRoute('/team/$teamId/links/all-links')({
...
function AllLinksPage() {
  ...
  const { data: linksData, isLoading, isFetching } = useQuery({
    queryKey: ['links', teamId, 'all', useSearch, searchParams],
    queryFn: () => {
      ...
      return serverGetAllLinks({ data: { teamId } })
    },
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  })
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage and organize your team's links</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center h-full py-12">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                {useSearch
                  ? 'No links match your search criteria. Try adjusting your search or filters.'
