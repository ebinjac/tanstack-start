...
export const Route = createFileRoute('/team/$teamId/links/public')({
...
function PublicLinksPage() {
  ...
  const searchParams = useMemo(() => ({
    ...
    visibility: 'team' as const, // Always filter for public/team links
  ...
  const { data: linksData, isLoading, isFetching } = useQuery({
    queryKey: ['links', teamId, 'public', useSearch, searchParams],
    queryFn: () => {
      // If search or filters are active, use search function
      if (useSearch) {
        return serverSearchLinks({ data: searchParams })
      }
      // Otherwise use regular query for public links
      return serverGetPublicLinks({ data: { teamId } })
    },
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  })
    ...
    try {
      switch (action) {
        ...
        case 'export':
          ...
          a.href = url
          a.download = 'public-links-export.json'
          a.click()
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Links shared with your entire team</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full py-12">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">No public links found</h3>
              <p className="text-muted-foreground mb-6 max-w-md">
                {useSearch
                  ? 'No public links match your search criteria. Try adjusting your search or filters.'
                  : 'Create public links to share with your team'
                }
              </p>
              {!useSearch && (
