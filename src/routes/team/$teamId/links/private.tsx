...
export const Route = createFileRoute('/team/$teamId/links/private')({
...
function PrivateLinksPage() {
  ...
  const searchParams = useMemo(() => ({
    ...
    visibility: 'private' as const, // Always filter for private links
  ...
  const { data: linksData, isLoading, isFetching } = useQuery({
    queryKey: ['links', teamId, 'private', useSearch, searchParams],
    queryFn: () => {
      // If search or filters are active, use search function
      if (useSearch) {
        return serverSearchLinks({ data: searchParams })
      }
      // Otherwise use regular query for private links
      return serverGetPrivateLinks({ data: { teamId } })
    },
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  })
    ...
    try {
      switch (action) {
        ...
        case 'export':
          ...
          a.href = url
          a.download = 'private-links-export.json'
          a.click()
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Links visible only to you</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full py-12">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">No private links found</h3>
              <p className="text-muted-foreground mb-6 max-w-md">
                {useSearch
                  ? 'No private links match your search criteria. Try adjusting your search or filters.'
                  : 'Create private links for personal use'
                }
              </p>
              {!useSearch && (
